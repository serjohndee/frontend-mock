// https://onboard.blocknative.com/examples/connect-wallet
...
export default function ConnectWallet() {
  const { wallet, account, connecting, connect, disconnect } = useContext(ContractContext);
  ...
  //     })
  //    console.log("conenctWallet:", wallet.accounts[0].balance);
  //   }
  // }, [wallet])
      ...
      <div className="flex items-center">
        <div className="flex-shrink-0 flex items-center gap-3">
          ...
          <button type="button"
            ...
            {String(account.address).slice(0, 10).concat("...")}
            {/* {String(balanceNumber).slice(0, 7).concat(" Ξ")} */}
